...
import { AiTeamCenterProvider } from "@/providers/ai-team-center";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="bg-white p-4 rounded-lg border border-blue-200">
                    ...
                    <p className="text-gray-700">
                      Ask about your return policy, shipping, pricing, and
                      product details to see if your AI has learned these key
                      topics.
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border border-blue-200">
