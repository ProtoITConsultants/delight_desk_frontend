import { Building, Mail, Package, Truck } from "lucide-react";
...
const FULLFILLMENT_METHODS = [
  {
    ...
    description:
      "Send emails to your warehouse team for manual order cancellation",
    icon: Mail,
    color:
  ...
  },
  {
    ...
    description:
      "Automatically cancel orders through ShipBob API before fulfillment",
    icon: Package,
    color:
      "bg-purple-50 dark:bg-purple-950/20 border-purple-200 dark:border-purple-800",
    features: [
      "Automatic API cancellation",
  ...
  },
  {
    ...
    description:
      "Automatically cancel orders through ShipStation before shipping",
    icon: Truck,
    color:
